...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Perfectcoin");
    QApplication::setOrganizationDomain("perfectcoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Perfectcoin-Qt-testnet");
    else
        QApplication::setApplicationName("Perfectcoin-Qt");
