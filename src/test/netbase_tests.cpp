...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:29875", "127.0.0.1", 29875));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:29875", "127.0.0.1", 29875));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:29875", "::ffff:127.0.0.1", 29875));
    BOOST_CHECK(TestSplitHost("[::]:29875", "::", 29875));
    BOOST_CHECK(TestSplitHost("::29875", "::29875", -1));
    BOOST_CHECK(TestSplitHost(":29875", "", 29875));
    BOOST_CHECK(TestSplitHost("[]:29875", "", 29875));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:29875", "127.0.0.1:29975"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:29875"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:29875", "[::]:29875"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
